...
INSERT INTO public.sellers OVERRIDING SYSTEM VALUE VALUES (1, 'Tienda Electrónica', 'contacto@tiendaelectronica.com', 'Especialistas en gadgets y dispositivos electrónicos.');
INSERT INTO public.sellers OVERRIDING SYSTEM VALUE VALUES (2, 'Hogar y Más', 'info@hogarymas.com', 'Todo lo que necesitas para tu hogar.');
INSERT INTO public.sellers OVERRIDING SYSTEM VALUE VALUES (3, 'Moda Urbana', 'ventas@modaurbana.com', 'Ropa y accesorios con estilo urbano.');
INSERT INTO public.sellers OVERRIDING SYSTEM VALUE VALUES (4, 'Librería Central', 'contacto@libreriacentral.com', 'Libros de todos los géneros y para todas las edades.');
INSERT INTO public.sellers OVERRIDING SYSTEM VALUE VALUES (5, 'Juguetería Feliz', 'info@jugueteriafeliz.com', 'Juguetes para niños de todas las edades.');
INSERT INTO public.sellers OVERRIDING SYSTEM VALUE VALUES (6, 'Tecnología Avanzada', 'soporte@tecnologiaavanzada.com', 'Lo último en tecnología y gadgets.');
INSERT INTO public.sellers OVERRIDING SYSTEM VALUE VALUES (7, 'Cocina y Hogar', 'ventas@cocinayhogar.com', 'Productos de cocina y hogar de alta calidad.');
INSERT INTO public.sellers OVERRIDING SYSTEM VALUE VALUES (8, 'Deportes y Aventura', 'contacto@deportesyaventura.com', 'Equipamiento para deportes y actividades al aire libre.');
INSERT INTO public.sellers OVERRIDING SYSTEM VALUE VALUES (9, 'Belleza y Salud', 'info@bellezaysalud.com', 'Productos de belleza y cuidado personal.');
INSERT INTO public.sellers OVERRIDING SYSTEM VALUE VALUES (10, 'Joyería Exclusiva', 'ventas@joyeriaexclusiva.com', 'Joyas únicas y exclusivas.');
INSERT INTO public.sellers OVERRIDING SYSTEM VALUE VALUES (11, 'Mundo Infantil', 'contacto@mundoinfantil.com', 'Ropa y accesorios para bebés y niños.');
INSERT INTO public.sellers OVERRIDING SYSTEM VALUE VALUES (12, 'Electrodomésticos Plus', 'info@electrodomesticosplus.com', 'Electrodomésticos de última generación.');
INSERT INTO public.sellers OVERRIDING SYSTEM VALUE VALUES (13, 'Ropa Deportiva', 'ventas@ropadeportiva.com', 'Ropa y accesorios para deportistas.');
INSERT INTO public.sellers OVERRIDING SYSTEM VALUE VALUES (14, 'Arte y Cultura', 'contacto@arteycultura.com', 'Obras de arte y artículos culturales.');
INSERT INTO public.sellers OVERRIDING SYSTEM VALUE VALUES (15, 'Mascotas Felices', 'info@mascotasfelices.com', 'Todo para el cuidado de tus mascotas.');
...
SELECT pg_catalog.setval('public.sellers_id_seq', 15, true);
...
--
-- Name: sellers sellers_correo_electronico_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.sellers
    ADD CONSTRAINT sellers_correo_electronico_key UNIQUE (correo_electronico);
...
ALTER TABLE ONLY public.products
    ADD CONSTRAINT products_vendedor_id_fkey FOREIGN KEY (vendedor_id) REFERENCES public.sellers(id);
